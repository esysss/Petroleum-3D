...
while True:
    ...
    if axis == "finished":
        break
    tensor, block_counter,flag_tensor, forbidden = t.merge(axis, tensor, flag_tensor, temp_lambda[0], temp_address, block_counter, N_limit)
    ...
    if counter_saver%100 == 0:
        ...
        theFile = open("perm_results.p", "wb")
        # theFile = open("Store/phi_results.p", "wb")
